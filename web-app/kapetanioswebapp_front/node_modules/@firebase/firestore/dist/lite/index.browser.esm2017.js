...
class __PRIVATE_DatastoreImpl extends class Datastore {} {
    ...
    terminate() {
        this.J = !0, this.connection.terminate();
    }
}
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
    ...
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.ht, t.ht);
    }
}
...
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
    ...
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.ht, t.ht);
    }
}
 ...
 */ (t)) throw t;
 // Failure will be handled by AsyncQueue
    ...
    Nt(t) {
        const e = this.Ct.then((() => (this.Ft = !0, t().catch((t => {
            this.gt = t, this.Ft = !1;
            const e = 
            /**
